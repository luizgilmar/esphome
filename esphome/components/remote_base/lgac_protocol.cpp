...
void LGacProtocol::encode(RemoteTransmitData *dst, const LGData &data) {
...
optional<LGData> LGacProtocol::decode(RemoteReceiveData src) {
  LGData out{
      .data = 0,
      .nbits = 0,
  };
...
void LGacProtocol::dump(const LGData &data) {
